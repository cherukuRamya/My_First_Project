...
public class Stegno extends JFrame implements ActionListener,Serializable{
    ...
    public Stegno(){
       ...
       label1 = new JLabel("Securing Data in Internet of Things Using Cryptography and Steganography Techniques");
        getContentPane().add(label1);
        
        label1.setFont(new Font("RockWell", Font.BOLD, 15));
        

        cbg = new ButtonGroup();
        radio1 = new JRadioButton("STEGANO", false);
        cbg.add(radio1);
        ...
        radio2 = new JRadioButton("UN STEGANO", false);
        cbg.add(radio2);
